...
# build vocabulary by sorting tokens

AUTOTUNE = tf.data.experimental.AUTOTUNE
def configure_dataset(dataset): # function in example 1
...
keys = vocab
values = range(2, len(vocab) + 2) # reserve padding, 1 for OOV
...
def create_model(vocab_size, num_labels): # function in example 1
...
preprocess_layer = TextVectorization( # tokenize
